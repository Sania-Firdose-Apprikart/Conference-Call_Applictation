...
const CustomizedGrid = styled(Grid)(({ theme }) =>
  getCustomizedGridStyle(theme)
);

function Footer(props) {
  // eslint-disable-next-line
  const { id: paramId } = useParams();
  const id = isComponentMode() ? getRootAttribute("data-room-name") : paramId;
    ...
    >
      <Grid item sx={{ display: { xs: "none", sm: "block" } }}>
        <Grid container alignItems={"center"}>
          {process.env.REACT_APP_FOOTER_APP_LOGO_VISIBILITY === "true" ? (
            <a
              href={process.env.REACT_APP_FOOTER_LOGO_ON_CLICK_URL}
              target="_blank"
              rel="noreferrer"
            >
              <img
                ...
                alt="Antmedia Circle"
                style={{ width: "22px", marginRight: 4 }}
              />
            </a>
          ) : null}
      ...
      {props?.isPlayOnly === false || props?.isEnterDirectly === false ? (
        <Grid item>
          ...
          >
            {process.env.REACT_APP_FOOTER_OPTION_BUTTON_VISIBILITY ===
            "true" ? (
              <Grid item xs={0}>
                <OptionButton
                  footer={true}
            ...
            !isMobile &&
            !isTablet &&
            process.env.REACT_APP_FOOTER_SCREEN_SHARE_BUTTON_VISIBILITY ===
              "true" &&
            ...
            {windowWidth > mobileBreakpoint &&
            process.env.REACT_APP_FOOTER_REACTIONS_BUTTON_VISIBILITY ===
              "true" ? (
              <Grid item xs={0} style={{ display: "-webkit-inline-box" }}>
                <ReactionsButton
                  footer={true}
                  ...
                  setShowEmojis={(showEmojis) =>
                    props?.setShowEmojis(showEmojis)
                  }
                />
              </Grid>
            ) : null}
            ...
            {windowWidth > mobileBreakpoint &&
            process.env.REACT_APP_FOOTER_MESSAGE_BUTTON_VISIBILITY ===
              "true" ? (
              <Grid item xs={0}>
                <MessageButton
                  footer={true}
                  ...
                  toggleSetNumberOfUnreadMessages={() =>
                    props?.toggleSetNumberOfUnreadMessages()
                  }
            ...
            {windowWidth > mobileBreakpoint &&
            process.env.REACT_APP_FOOTER_PARTICIPANT_LIST_BUTTON_VISIBILITY ===
              "true" ? (
              <Grid item xs={0}>
            ...
            {windowWidth > mobileBreakpoint &&
            process.env.REACT_APP_FOOTER_PUBLISHER_REQUEST_BUTTON_VISIBILITY ===
              "true" &&
            props?.isAdmin === true ? (
              <Grid item xs={0}>
                <PublisherRequestListButton
                  ...
                  handlePublisherRequestListOpen={(open) =>
                    props?.handlePublisherRequestListOpen(open)
                  }
                />
              </Grid>
            ) : null}
            ...
            {process.env.REACT_APP_FOOTER_END_CALL_BUTTON_VISIBILITY ===
            "true" ? (
              <Grid item xs={0}>
                <EndCallButton
                  footer={true}
            ...
            {windowWidth <= mobileBreakpoint ? (
              <Grid item xs={0}>
                <MoreOptionsButton
                  ...
                  messageDrawerOpen={props?.messageDrawerOpen}
                  toggleSetNumberOfUnreadMessages={(numberOfUnreadMessages) =>
                    props?.toggleSetNumberOfUnreadMessages(

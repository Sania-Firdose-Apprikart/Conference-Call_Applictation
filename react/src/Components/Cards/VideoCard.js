...
function VideoCard(props) {
      ...
      >
        ...
        >
          <Grid
            ...
            columnSpacing={0.5}
          >
            {!isMobile && !isTablet && <PinButton />}
            {isAdministrativeButtonsVisible && (
              <AdministrativeButtons
                micMuted={micMuted}
                useAvatar={useAvatar}
              />
            )}
  ...
  }, [displayHover, props, micMuted, useAvatar]);
      ...
      <div className="name-indicator">
        <Typography color="#fff" align="left" className="name">
          ...
          {/* {process.env.NODE_ENV === "development" &&
            ` ${
              props?.trackAssignment.isMine
                ? props.trackAssignment.streamId + " " + props?.streamName
                : props.trackAssignment.streamId +
                  " " +
                  props.trackAssignment.track?.id
            }`} */}
        </Typography>
      </div>
    );
  ...
  return isMine || isVideoTrack ? (
    ...
    >
      ...
      <div
        ...
        id={"card-" + (props.trackAssignment.streamId || "")}
        style={cardStyle}
      >
